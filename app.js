window.onload = function(){
    ...
    // move left only if dont hit another teromoino or wall 
    ...
    // move right only if dont hit another teromino or wall
    function moveright(){
        undraw()
  ...
  function checkRotatedPosition(P){
    ...
    function rotate(){
        ...
        currentRotation++
        if(currentRotation === current.length){  // if currentRotation is 4 make it go to back with 0
        currentRotation = 0
        }
        current = theTetrominoes[random][currentRotation]
    ...
    //display first rotation in mini grid
